package com.cvnavi.logistics.i51eyun.app.extra;
...
public class EmptyLayout {
    ...
    private String mErrorMessage = "请求服务错误！";
     ...
     */
    protected void setShowLoadingButton(boolean showLoadingButton) {
    ...
    private void setDefaultValues() {
        if (mEmptyView == null) {
            mEmptyView = (ViewGroup) mInflater.inflate(R.layout.layout_empltylayout_empty, null);
        ...
        if (mLoadingView == null) {
            mLoadingView = (ViewGroup) mInflater.inflate(R.layout.layout_emptylayout_loading, null);
        ...
        if (mErrorView == null) {
            mErrorView = (ViewGroup) mInflater.inflate(R.layout.layout_emptylayout_error, null);
