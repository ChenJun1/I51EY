 ...
 */
public class DriverMileageLastThreeDayFragment extends BaseFragment implements LocationChooseCarCallback {
    ...
    public static DriverMileageLastThreeDayFragment getInstance() {
        return new DriverMileageLastThreeDayFragment();
    }
    ...
    private void initView() {
        ...
        CarStartTimeEt.setText(DateUtil.getBeforeDayNsTime(3,DateUtil.FORMAT_YMDHM));
