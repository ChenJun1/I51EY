...
import com.cvnavi.logistics.i51eyun.app.activity.driver.home.mytask.adpter.MyTaskDetailedAdpter;
...
//        SetViewValueUtil.setTextViewValue(LetterOidTv, taskBean.Letter_Oid);
        ...
        SetViewValueUtil.setTextViewValue(ShuttleFee, taskBean.Shuttle_Fee, " 元");
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.operation_btn:
                Intent intent = new Intent(this, MyTaskExceptionInfoActivity.class);
                LogUtil.d("-->> taskben3");
                if (taskBean != null) {
                    LogUtil.d("-->> taskben4");
