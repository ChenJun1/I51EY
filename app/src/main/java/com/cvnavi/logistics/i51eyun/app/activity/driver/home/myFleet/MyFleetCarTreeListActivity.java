...
import com.cvnavi.logistics.i51eyun.app.activity.driver.adapter.home.myFleet.MyFleetCarTreeAdapter;
...
public class MyFleetCarTreeListActivity extends BaseActivity implements MyOnClickItemListener {
    ...
    public void myOnClickItem(int position, Object data) {
        mCarInfo info = (mCarInfo) data;
        Intent intent = new Intent();
        intent.putExtra("Org_Code", info.Org_Code);
