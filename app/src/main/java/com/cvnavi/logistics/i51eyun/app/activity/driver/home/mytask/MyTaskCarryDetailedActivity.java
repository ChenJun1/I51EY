...
import com.cvnavi.logistics.i51eyun.app.activity.driver.home.mytask.adpter.MyTaskCarryDetailedAdpter;
import com.cvnavi.logistics.i51eyun.app.activity.driver.home.mytask.exception.MyTaskExceptionInfoActivity;
...
import com.cvnavi.logistics.i51eyun.app.bean.response.TaskDetaieldOrderListBeanResponse;
...
//    TextView CarCodeNoTv;
    ...
    private void init() {
        ...
        if (Utils.checkOperate(Constants.OPERATE_CD_CONFIRM_ARRVIED)) {
...
//        SetViewValueUtil.setTextViewValue(CarCodeNoTv, taskBean.CarCode_No);
        ...
        SetViewValueUtil.setTextViewValue(BulkWeightTv, taskBean.Bulk_Weight, "m³");
        SetViewValueUtil.setTextViewValue(GoodsWeightTv, taskBean.Goods_Weight, "kg");
        ...
        SetViewValueUtil.setTextViewValue(TrafficModeTv, taskBean.Traffic_Mode == "整车" ? "整" : "配");
        SetViewValueUtil.setTextViewValue(LineTypeTv, taskBean.Line_Type == "干线" ? "干" : "支");
        if (!TextUtils.isEmpty(taskBean.TicketStatus) && taskBean.TicketStatus.equals("已完成")) {
            carry_operation_btn.setVisibility(View.GONE);
        }
    }
