 ...
 */
public class DriverMileageLastMonthFragment extends BaseFragment implements LocationChooseCarCallback {
    ...
    public static DriverMileageLastMonthFragment getInstance() {
        return new DriverMileageLastMonthFragment();
    }
    ...
    private void initView() {
        ...
        CarStartTimeEt.setText(DateUtil.getBeforeDayNsTime(30,DateUtil.FORMAT_YMDHM));
