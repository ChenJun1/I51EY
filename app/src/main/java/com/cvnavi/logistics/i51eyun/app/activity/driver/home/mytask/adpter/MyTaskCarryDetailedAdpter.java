...
public class MyTaskCarryDetailedAdpter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SetViewValueUtil.setTextViewValue(viewHolder.GoodsWeightTv,bean.Goods_Weight,"kg");
        SetViewValueUtil.setTextViewValue(viewHolder.BulkWeightTv,bean.Bulk_Weight,"m³");
