 ...
 * 司机调度运输昨天排班界面
 */
public class DriverTransLastDayFragment extends BaseFragment implements OnClickItemListener {
    ...
    public static DriverTransLastDayFragment getInstance() {
        return new DriverTransLastDayFragment();
