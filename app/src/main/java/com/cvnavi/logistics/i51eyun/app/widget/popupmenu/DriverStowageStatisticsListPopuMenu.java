 ...
 * 配载清单列表 Popu
 */
public class DriverStowageStatisticsListPopuMenu extends PopupWindow implements View.OnClickListener{
    ...
    public DriverStowageStatisticsListPopuMenu(Activity activity) {
        super(activity);
        ...
        tx_item2.setText("整车");
        tx_item3.setText("配货");
        tx_item4.setVisibility(View.GONE);
