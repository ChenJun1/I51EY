 ...
 * 应付款统计
 */
public class DriverAccountsPayableMainActivity extends BaseActivity {
    ...
    private void init() {
        ...
        list.add(DriverAccountPayLastDayFragment.getInstance());
        list.add(DriverAccountPayThreeDayFragment.getInstance());
        list.add(DriverAccountPayOneMonthFragment.getInstance());
        if (adapter == null) {
