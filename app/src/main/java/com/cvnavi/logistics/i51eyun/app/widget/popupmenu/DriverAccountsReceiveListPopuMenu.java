package com.cvnavi.logistics.i51eyun.app.widget.popupmenu;
 ...
 */
public class DriverAccountsReceiveListPopuMenu extends PopupWindow implements View.OnClickListener{
    ...
    public DriverAccountsReceiveListPopuMenu(Activity activity) {
        super(activity);
        ...
        tx_item1.setText("全部");
        tx_item2.setText("已收款");
        tx_item3.setText("部分收款");
        tx_item4.setText("未收款");
