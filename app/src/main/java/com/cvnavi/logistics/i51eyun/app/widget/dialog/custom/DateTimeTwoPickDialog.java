...
import com.cvnavi.logistics.i51eyun.app.extra.datepicker.ArrayWheelAdapter;
import com.cvnavi.logistics.i51eyun.app.extra.datepicker.OnWheelChangedListener;
import com.cvnavi.logistics.i51eyun.app.extra.datepicker.OnWheelScrollListener;
import com.cvnavi.logistics.i51eyun.app.extra.datepicker.WheelView;
...
//		curMinute = calendar.get(Calendar.MINUTE);
    ...
    public void dateTimePicKDialog(final Context context, final View view,
        ...
        dateTimeLayout = mLayoutInflater.inflate(
                R.layout.layout_popup_datepicker_two, null);
     ...
     * @return
     */
    public void dateWithOutYYDialog(final Context context, final View view,
                                    String title) {
        ...
        confirmBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (view instanceof TextView) {
                    ((TextView) view).setText(month.trim()
                            + "-" + day.trim() + " " + hour.trim() + ":"
                            + minute.trim());
                    setResultData(year.trim() + "-" + month.trim()
                            + "-" + day.trim() + " " + hour.trim() + ":"
                            + minute.trim());

                } else if (view instanceof EditText) {
                    ((EditText) view).setText(month.trim()
                            + "-" + day.trim() + " " + hour.trim() + ":"
                            + minute.trim());
                    setResultData(year.trim() + "-" + month.trim()
                            + "-" + day.trim() + " " + hour.trim() + ":"
