...
import com.cvnavi.logistics.i51eyun.app.activity.driver.home.myorder.adapter.DriverExceptionInfoAdapter;
...
import com.cvnavi.logistics.i51eyun.app.bean.response.GetExceptionResponse;
...
public class DriverExceptionInfoActivity extends BaseActivity {
    ...
    private void init() {
        ...
        loadDataRequest(TMSService.GetExceptInfo_Request_Url);
    }
