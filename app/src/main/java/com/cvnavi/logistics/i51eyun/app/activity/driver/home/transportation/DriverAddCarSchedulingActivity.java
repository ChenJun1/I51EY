 ...
 * 添加车辆排班
 */
public class DriverAddCarSchedulingActivity extends BaseActivity implements LocationChooseCarCallback, DriverChoiceCallback, LineChoiceCallback {
...
//                TimePopupWindow timePopupWindow = new TimePopupWindow(DriverAddCarSchedulingActivity.this, TimePopupWindow.Type.HOURS_MINS);
...
//                timePopupWindow.showAtLocation(preTimeEt, Gravity.BOTTOM, 0, 0, new Date());
                ...
                preDia.dateWithOutYYDialog(DriverAddCarSchedulingActivity.this, preTimeEt, null);
                break;
            case R.id.confirm_btn:
                ...
                addCarShiftRequest.CarCodeSerial_Oid = mCarInfo.CarCode_Key;
