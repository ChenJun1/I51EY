...
package com.cvnavi.logistics.i51eyun.app.activity.driver.home.myFleet.fleetmonitor.algo;
...
import com.cvnavi.logistics.i51eyun.app.activity.driver.home.myFleet.fleetmonitor.projection.Bounds;
import com.cvnavi.logistics.i51eyun.app.activity.driver.home.myFleet.fleetmonitor.projection.SphericalMercatorProjection;
import com.cvnavi.logistics.i51eyun.app.activity.driver.home.myFleet.fleetmonitor.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.cvnavi.logistics.i51eyun.app.activity.driver.home.myFleet.fleetmonitor.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.cvnavi.logistics.i51eyun.app.activity.driver.home.myFleet.fleetmonitor.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.cvnavi.logistics.i51eyun.app.activity.driver.home.myFleet.fleetmonitor.algo.StaticCluster<T> cluster =
                        new com.cvnavi.logistics.i51eyun.app.activity.driver.home.myFleet.fleetmonitor.algo
