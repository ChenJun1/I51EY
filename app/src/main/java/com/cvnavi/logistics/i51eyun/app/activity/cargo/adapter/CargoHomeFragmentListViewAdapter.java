package com.cvnavi.logistics.i51eyun.app.activity.cargo.adapter;
 ...
 */
public class CargoHomeFragmentListViewAdapter extends BaseAdapter {
    ...
    public CargoHomeFragmentListViewAdapter(Context context, List<mOrder> list,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout
                    .layout_unfinished_order_item, null);
