package com.cvnavi.logistics.i51eyun.app.activity.driver.home.mytask.adpter;
 ...
 */
public class MyTaskOffTheStocksFragmenAdapter extends BaseAdapter {

    private ArrayList<TaskBean> list;
    private LayoutInflater mInflater;
    private MyTaskOffTheStocksListener listener;


    public MyTaskOffTheStocksFragmenAdapter(ArrayList<TaskBean> dataList, Context context, MyTaskOffTheStocksListener listener) {
        super();
        this.list = dataList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (taskBean != null) {
            if (!TextUtils.isEmpty(taskBean.Letter_Type_Oid) && taskBean.Letter_Type_Oid.equals("A")) {
                ...
                viewHolder.zhengcheBtn.setText("派车");
    ...
    public interface MyTaskOffTheStocksListener {
