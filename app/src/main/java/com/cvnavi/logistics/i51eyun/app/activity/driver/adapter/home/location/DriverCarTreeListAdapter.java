...
public class DriverCarTreeListAdapter extends BaseExpandableListAdapter {
    ...
    public int getChildrenCount(int groupPosition) {
        return mParents.get(groupPosition).mCarInfoList != null ? mParents.get(groupPosition).mCarInfoList.size() : 0;
    }
    ...
    public mCarInfo getChild(int groupPosition, int childPosition) {
        return mParents.get(groupPosition).mCarInfoList.get(childPosition);
    }
...
//                             int childPosition);
    ...
    class GroupHolder {
        ...
        public void update(mCarInfo model) {
            parentGroupTV.setText(model.CarCode);
        }
    }
}
