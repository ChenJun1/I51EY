...
import com.cvnavi.logistics.i51eyun.app.activity.driver.adapter.home.statistics.DriverAccountsPayableListAdapter;
import com.cvnavi.logistics.i51eyun.app.bean.model.GetPaymentList.PayFeeStatistics;
import com.cvnavi.logistics.i51eyun.app.bean.model.GetPaymentList.PayFeelist;
import com.cvnavi.logistics.i51eyun.app.bean.model.GetPaymentList.mGetPaymentList;
import com.cvnavi.logistics.i51eyun.app.bean.request.DataRequestBase;
import com.cvnavi.logistics.i51eyun.app.bean.request.GetPaymentListRequest;
import com.cvnavi.logistics.i51eyun.app.bean.response.GetPaymentListResponse;
...
import com.cvnavi.logistics.i51eyun.app.widget.popupmenu.DriverAccountsPayableListPopupMenu;
...
public class DriverAccountsPayableListActivity extends BaseActivity {
    ...
    com.cvnavi.logistics.i51eyun.app.bean.model.PaymentStatistics.PayFeeStatistics bean;
    ...
    private void init() {
        ...
        if (mIntent.getStringExtra("ActivityName").equals("DriverAccountPayLastDayFragment")) {
            ...
            bean = (com.cvnavi.logistics.i51eyun.app.bean.model.PaymentStatistics.PayFeeStatistics) mIntent.getSerializableExtra("Data");
    ...
    private void requestHttp() {
        ...
        LogUtil.d("-----request="+request.Pay_Status);
...
//                        DialogUtils.showMessageDialogOfDefaultSingleBtnNoCancel(DriverAccountsPayableListActivity.this,"未获取到数据", new CustomDialogListener() {
//                            @Override
