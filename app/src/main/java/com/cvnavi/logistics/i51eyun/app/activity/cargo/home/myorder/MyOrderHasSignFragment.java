...
import com.cvnavi.logistics.i51eyun.app.activity.cargo.adapter.home.myorder.MyOrderAdapter;
 ...
 */
public class MyOrderHasSignFragment extends BaseFragment implements OnClickItemListener {
    ...
    public static MyOrderHasSignFragment getInstance() {
        return new MyOrderHasSignFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        pullRefreshList.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            ...
            public void onPullDownToRefresh(PullToRefreshBase<ListView> refreshView) {
                ...
                //执行刷新
                getOrderList(DateUtil.getLastNDays(-7), DateUtil.getLastNDays(0), false, "3");
            }
    ...
    public void onResume() {
        ...
        isRefresh = true;
        if (activity.getCurPosition() == 0) {
            if (activity.beginDate != null) {
                LogUtil.d("-->>end " + activity.endDate + "||begin" + activity.beginDate);
                getOrderList(activity.beginDate, activity.endDate, true, "3");
            } else {
                getOrderList(DateUtil.getLastNDays(-7), DateUtil.getLastNDays(0), true, "3");
            }
        }
