...
public class DriverChildAdapter extends BaseExpandableListAdapter {
    ...
    public int getChildrenCount(int groupPosition) {
        return mChilds.get(groupPosition).mCarInfoList != null ? mChilds
                .get(groupPosition).mCarInfoList.size() : 0;
    }
    ...
    public mCarInfo getChild(int groupPosition, int childPosition) {
        if (mChilds.get(groupPosition).mCarInfoList != null
                && mChilds.get(groupPosition).mCarInfoList.size() > 0)
            return mChilds.get(groupPosition).mCarInfoList
                    .get(childPosition);
        return null;
    }
