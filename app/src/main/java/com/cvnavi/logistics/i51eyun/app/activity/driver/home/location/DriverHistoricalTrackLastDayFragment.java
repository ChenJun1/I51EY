 ...
 */
public class DriverHistoricalTrackLastDayFragment extends BaseFragment implements LocationChooseCarCallback {
    ...
    public static DriverHistoricalTrackLastDayFragment getInstance() {
        return new DriverHistoricalTrackLastDayFragment();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.query_btn:
                ...
                if (DateUtil.compareDateOneDay(CarStartTimeEt.getText().toString(), CarEndTimeEt.getText().toString()) == 2) {
                    DialogUtils.showNormalToast("最多查询1天数据！");
                    return;
                }
                ...
                Intent intent2 = new Intent(getActivity(), DriverRecordMainActivity.class);
                ...
                LogUtil.d("-->> put Data = " + intent2.getStringExtra("startTime"));
