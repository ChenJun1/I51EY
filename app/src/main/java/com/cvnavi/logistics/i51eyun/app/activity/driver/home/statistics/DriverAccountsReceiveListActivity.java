...
import com.cvnavi.logistics.i51eyun.app.activity.driver.adapter.home.statistics.DriverAccountReveivableListAdapter;
import com.cvnavi.logistics.i51eyun.app.bean.model.GatherFeeStatistics.GatherFeeList;
import com.cvnavi.logistics.i51eyun.app.bean.model.GatherFeeStatistics.GatherFeeStatistics;
import com.cvnavi.logistics.i51eyun.app.bean.model.GatherFeeStatistics.mGatherFeeStatistics;
import com.cvnavi.logistics.i51eyun.app.bean.request.DataRequestBase;
import com.cvnavi.logistics.i51eyun.app.bean.request.GetReceivablesListRequest;
import com.cvnavi.logistics.i51eyun.app.bean.response.GetReceivablesListResponse;
...
import com.cvnavi.logistics.i51eyun.app.widget.popupmenu.DriverAccountsReceiveListPopuMenu;
...
public class DriverAccountsReceiveListActivity extends BaseActivity {
    ...
    com.cvnavi.logistics.i51eyun.app.bean.model.ReceivableAccount.GatherFeeStatistics bean;
    ...
    private void init() {
        ...
        if (mIntent.getStringExtra("ActivityName").equals("DriverAccountReceiveLastDayFragment")) {
            ...
            bean = (com.cvnavi.logistics.i51eyun.app.bean.model.ReceivableAccount.GatherFeeStatistics) mIntent.getSerializableExtra("Data");
...
//                        DialogUtils.showMessageDialogOfDefaultSingleBtnNoCancel(DriverAccountsReceiveListActivity.this, "未获取到数据", new CustomDialogListener() {
//                            @Override
