package com.cvnavi.logistics.i51eyun.app.service;
...
public class MyCheckLoginService extends Service {
    ...
    private void checkLogin() {
        ...
        VolleyManager.newInstance().PostJsonRequest(LoginService.GetAppAutoLogin_TAG, LoginService.GetAppAutoLogin_Request_Url, GsonUtil.newInstance().toJson(dataRequestBase), new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject jsonObject) {
                GetAppLoginResponse info = GsonUtil.newInstance().fromJson(jsonObject, GetAppLoginResponse.class);
                if (!info.Success && info.ErrorText.equals("Displace")) {
                ...
                getHttpHandler.sendEmptyMessageDelayed(0x12, 3000);
            }
