...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = Color.parseColor("#3A95E6"); // Color.parseColor("#3A95E6"); // 0xFF666666

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFF666666; // Color.parseColor("#3A95E6"); // 0xFF666666
